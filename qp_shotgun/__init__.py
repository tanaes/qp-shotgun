...
opt_params = {
    ...
    'bypass-prescreen': ['bool', 'False'],
    'bypass-nucleotide-index': ['bool', 'False'],
    'bypass-translated-search': ['bool', 'False'],
    'bypass-nucleotide-search': ['bool', 'False'],
    ...
    'remove-stratified-output': ['bool', 'False'],
